<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AliyunPage.aspx.cs" Inherits="Modules_AliyunPage" %>
    ...
    <div id="page" class="container">
        <div style="position:relative; margin-top:2px; height:480px">
            <div style="margin-top:10px;">
                <a href="http://s.click.taobao.com/t?e=m%3D2%26s%3Dklhx8FKdcYkcQipKwQzePCperVdZeJviEViQ0P1Vf2kguMN8XjClAjASvnrdZms11A3MegFRtzMkc%2BJkkjZadETqffRqk7YaOkq9WE57tQvfwBLAdMLJSedn1BbglxZYxUhy8exlzcq9AmARIwX9K%2BnbtOD3UdznPV1H2z0iQv9NkKVMHClW0QbMqOpFMIvnvjQXzzpXdTHGJe8N%2FwNpGw%3D%3D" target="_blank"><img src="/images/aliyun300x100.jpg" /></a>
            </div>
        </div>
    </div>
