...
;(function($){
	$.fn.colorpicker = function(){
        var self = $(this),
            it = self.attr('data-it'),
            ic = self.attr('data-ic');

        self.die('click').live('click', function(){
            createPicker(self.parent());
        ...
        var createPicker = function(obj){
            ...
            $('#ColorPicker table.pickerTable').css({
