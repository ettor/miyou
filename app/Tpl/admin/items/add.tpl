	...
	<div class="col_tab">
		...
		<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
			...
			<tr>
				...
				<th>IID :</th>
				<td><input type="text" name="num_iid" id="J_num_iid" class="input-text" size="20" ></td>
				<th>掌柜旺旺 :</th>
			...
			<tr>
				...
				<th>长方形图片 :</th>
				<td><input type="text" name="pic_urls" class="input-text"  id="J_pic_urls" size="50"></td>
			</tr>
			<tr>
				<th></th>
			...
			<tr>
				<th>详细内容 :</th>
                <td><textarea name="content" id="info" style="width:100%;height:400px;visibility:hidden;resize:none;"></textarea></td>
			</tr>
		</table>
		</div>
		...
		if (link != '') {
			$.getJSON(collect_url, {url:link}, function(result){
				if(result.status == 1){
					...
					$('#shop_type').val(result.data.tmall);
