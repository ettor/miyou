...
<!--清理缓存-->
<div class="subnav">
    <h1 class="title_2 line_x">{:L('clear_cache')}</h1>
</div>
<div class="common-form pad_lr_10">
	<form id="info_form" action="{:u('cache/clear')}" method="post">
		<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
			...
			<tr>
				<th></th>
				<td><label><input type="checkbox" checked value="js" name="type" class="mr5" data-uri="{:U('cache/clear', array('type'=>'js'))}"> JS缓存文件</label></td>
				<td><span class="gray mr10">修改过JS文件需要更新才会生效</span><span id="js_ifm"></span></td>
			</tr>

			<tr>
				<th></th>
				<td><label><input type="checkbox" checked value="api" name="type" class="mr5" data-uri="{:U('cache/clear', array('type'=>'api'))}"> 飞天侠API缓存</label></td>
