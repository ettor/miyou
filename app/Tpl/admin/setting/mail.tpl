...
<div class="common-form">
    ...
    <table width="100%" class="table_form contentWrap">
        <tr>
        	...
        	<td><input type="text" name="setting[mail_server][host]" class="input-text" size="30" value="{:C('ftx_mail_server.host')}">
       	    <a href="http://bbs.138gzs.com/forum-49-1.html" target="_blank">点击查看相关操作教程</a></td>
    	</tr>
        <tr>
        	<th>{:L('smtp_port')} :</th>
        	<td><input type="text" name="setting[mail_server][port]" class="input-text" value="{:C('ftx_mail_server.port')}"></td>
    	</tr>
        <tr>
        	<th>{:L('smtp_from')} :</th>
        	<td><input type="text" name="setting[mail_server][from]" class="input-text" size="30" value="{:C('ftx_mail_server.from')}"></td>
    	</tr>
        <tr>
        	<th>{:L('smtp_auth_username')} :</th>
        	<td>
            	<input type="text" name="setting[mail_server][auth_username]" class="input-text" size="30" value="{:C('ftx_mail_server.auth_username')}">
            </td>
    	</tr>
        <tr>
