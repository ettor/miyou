...
<div class="pad_lr_10">
	...
	<tr>
            <th width="150">自动获取优惠券 :</th>
            <td>
                <label><input type="radio" <if condition="C('ftx_coupon_quan') eq '1'">checked="checked"</if> value="1" name="setting[coupon_quan]"> {:L('open')}</label> &nbsp;&nbsp;
                <label><input type="radio" <if condition="C('ftx_coupon_quan') eq '0'">checked="checked"</if> value="0" name="setting[coupon_quan]"> {:L('close')}</label>
                <span class="gray ml10">开启会严重影响速度！建议关闭该功能提升性能</span>
            </td>
        </tr>
	...
	<tr>
            <th width="150">内页商品详情链接 :</th>
            <td>
                <label><input type="radio" <if condition="C('ftx_desc_url') eq '1'">checked="checked"</if> value="1" name="setting[desc_url]"> 打开链接</label> &nbsp;&nbsp;
                <label><input type="radio" <if condition="C('ftx_desc_url') eq '0'">checked="checked"</if> value="0" name="setting[desc_url]"> 关闭链接</label>
                <span class="gray ml10">如果您的内页商品详情的链接打不开请选择关闭！</span>
            </td>
        </tr>
	...
	<tr>
		<th>顶部Logo图片 :</th>
			...
			<img src="{:C('ftx_site_logo')}" id="show_logo_J_img" style="width:240px;height:45px;"/><span class="attachment_icon J_attachment_icon" file-type="image" ></span>
		</td>
    	</tr>
	<tr>
		<th>左侧浮动Logo图片 :</th>
			...
			<img src="{:C('ftx_site_navlogo')}" id="show_navlogo_J_img" style="width:104px;height:60px;"/><span class="attachment_icon J_attachment_icon" file-type="image" ></span>
		</td>
    	</tr>
	<tr>
		<th>底部Logo图片 :</th>
			...
			<img src="{:C('ftx_site_flogo')}" id="show_flogo_J_img" style="width:225px;height:38px;"/><span class="attachment_icon J_attachment_icon" file-type="image" ></span>
		</td>
    	</tr>
	...
	<tr>
		<th>微信二维码 :</th>
			...
			<img src="{:C('ftx_site_weixin')}" id="show_weixin_J_img" style="width:80px;height:80px;"/><span class="attachment_icon J_attachment_icon" file-type="image" ></span>
		</td>
    	</tr>
	...
	<tr>
		<th>手机地址二维码 :</th>
			...
			<img src="{:C('ftx_site_browser')}" id="show_browser_J_img" style="width:80px;height:80px;"/><span class="attachment_icon J_attachment_icon" file-type="image" ></span>
		</td>
    	</tr>
