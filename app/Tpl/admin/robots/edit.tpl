        ...
        <tbody>
			<tr>
			 ...
			 <tr>
				...
				<td>
					<input type="radio" value="0" name="http_mode" class="radio" id="api_mod" <if condition="$info.http_mode eq '0'"> checked</if>>
            ...
            <tr>
                ...
                <td>
                    <select name="sort">
			<option value="normal|desc" <if condition="$info.sort eq 'normal|desc'"> selected</if>>默认</option>
			<option value="new|desc" <if condition="$info.sort eq 'new|desc'"> selected</if>>最新</option>
			<option value="volume|desc" <if condition="$info.sort eq 'volume|desc'"> selected</if>>销量</option>
			<option value="coefp|desc" <if condition="$info.sort eq 'coefp|desc'"> selected</if>>人气</option>
			<option value="ratesum|desc" <if condition="$info.sort eq 'ratesum|desc'"> selected</if>>信用</option>
                    </select>
                </td>
            </tr>
