	...
	<ul class="goods-list container" id="container">
		...
		<li class="item  <eq name="mod" value="2"> last</eq>">
			<div re="11okav" class="list-good goods_box todayDb">
				...
				<div class="good-pic">
					<div class="pic-img">
						<a href="{:U('item/index',array('id'=>$item['id']))}" target="_blank">
				...
				<div class="good-price">
					...
					<a class="btn {$item.class}" target="_blank" href="{:U('jump/index',array('id'=>$item['id']))}"  rel="nofollow" ></a>
				</div>
				<div class="good-des">
					<a href="#" class="icon tao-du" title="联推独家" target="_blank"></a>
