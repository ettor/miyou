...
<div class="login-main">
		...
		<div class="top">
			<div class="logo_show"><a href="{:C('ftx_site_url')}" title="{:C('ftx_site_name')}" class="jky"><img src="__STATIC__/jky/images/logo.png" width="254" height="80" /></a></div>
		</div>
		...
		<p><a href="http://www.miibeian.gov.cn/" rel="nofollow" target="_blank">{:C('ftx_site_icp')}</a> all Rights Reserved 
...
$(function(){
    $('#register_form').validate({
		...
		submitHandler: function(form) {   
			ajaxPostForm(form,'http://zhekou.52mai.net/index.php?mod=user&act=index');
        } */
    });
	});
