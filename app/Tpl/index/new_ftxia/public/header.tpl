...
<div class="head">
	<div class="logo {:C('ftx_site_width')}">
		...
		<if condition="C('ftx_site_logo') neq ''">
			<h1><a title="{:C('ftx_site_name')}" href="{:C('ftx_site_url')}"><img src="/{:C('ftx_site_logo')}" width="254" height="80" /></a><img src="/static/jky/images/hengtop.png" width="465" height="80" /></h1>
		<else />
			<h1><a title="{:C('ftx_site_name')}" href="{:C('ftx_site_url')}"><img src="/static/jky/images/logo3.png" width="254" height="80" /></a></h1>
		</if>
	...
	<div style="background-color:#1d7ad9">
	<div class="nav {:C('ftx_site_width')}">
		...
		<div class="state-show">
			...
			<tr>
			<td>
			<a style="font-weight:bold;color:#FFF" href="{:U('zhidemai/index')}" >手机充值</a>
			</td>
			<td>
