				...
				<div class="qqserver">
					...
					<p>
						...
						<if condition="C('ftx_kefu_two_su') eq 'qq'">
							<a href="http://wpa.qq.com/msgrd?v=3&amp;uin={:C('ftx_kefu_two_value')}&amp;site=qq&amp;menu=yes" rel="nofollow" target="_blank"><img border="0" src="http://wpa.qq.com/pa?p=2:{:C('ftx_kefu_two_value')}:51" alt="点击这里给我发消息" title="点击这里给我发消息"></a>
