		...
		<form action="{:U('goods/goods_edit',array('do'=>'submit'))}" method="post" name="form1" onsubmit="return check_zhe();">
			<div class="bm-form">
				...
				<table>
					...
					<tr>
						<th>商品库存：</th>
						<td>
							<input name="inventory" type="text" id="inventory" class="form-int form-int-extrashort" value="{$item.inventory}" />
							<span class="form-text">件</span>
						</td>
					</tr>
			...
			<div class="bm-form" style="border:0">
				<table>
					...
					<tr>
						<th>联系人手机：</th>
						<td><input name="telephone" type="text" id="telephone" class="form-int-short" value="{$item.mobile}" /></td>
					</tr>
					<tr>
						<th>联系人姓名：</th>
						<td><input name="person_name" type="text" id="person_name" class="form-int-short" value="{$item.realname}" /></td>
					</tr>
					<tr>
						<th>推荐理由：</th>
						<td>
