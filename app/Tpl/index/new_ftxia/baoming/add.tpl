	...
	<body>
		...
		<div class="main {:C('ftx_site_width')} mb20">
			<div class="main-newgood -2">
				<div class="procedures bc">	<span>报名流程</span>
	<em>1</em>发布活动<i></i>
	<em>2</em>活动审核<i></i>
	<em>3</em>确认排期<i></i>
	<em>4</em>活动上线</div>
					...
					<table>
						<tr>
							...
							<td>
								...
								<div class="form-tip">什么是商品网址？
									<br />如果您是B店，提供的商品格式为：<span class="org_2">http://detail.tmall.com/item.htm?id=26914584813</span>
									<br />如果您是C店，提供的商品格式为：<span class="org_2">http://item.taobao.com/item.htm?id=12345678910</span>
								</div>
							</td>
						</tr>
					</table>
				...
				<form action="{:U('goods/goods_add',array('do'=>'submit'))}" method="post" name="form1" onsubmit="return check_zhe();">
					<div class="bm-form">
						<div style="position:relative">
							<div class="pic">
								<img class="pic_url" src="__STATIC__/images/no_pic.png" width="340" height="340" alt="图片预览">	<span class="tip org_2">（商品图片必须无文字、无水印、300*300像素以上）</span>
							</div>
						</div>
						<table>
							<tr>
							...
							<tr>
								<th>图片链接：</th>
								<td>
									<input name="pic_url" type="text" id="pic_url" class="form-int-long" value="" />
								</td>
							</tr>
							<tr>
								<th>所属分类：</th>
							...
							<tr>
								<th>30天销量：</th>
								<td>
									<input name="volume" type="text" id="volume" class="form-int-extrashort bcf" value="" readOnly="true" />	<span class="form-text">件</span>&nbsp;&nbsp;&nbsp;&nbsp;</td>
							</tr>
							<tr>
								<th>商品库存：</th>
								<td>
									<input name="inventory" type="text" id="inventory" class="form-int-extrashort" value=""  />	<span class="form-text">件</span>
								</td>
							</tr>
							<tr>
								<th>商品原价：</th>
								<td>
									<input name="price" type="text" id="price" class="form-int-extrashort bcf" value="" readOnly="true" />	<span class="form-text">元</span>
								</td>
							</tr>
							<tr>
								<th>活动价格：</th>
								<td>
									<input name="coupon_price" type="text" id="coupon_price" class="form-int form-int-extrashort" value="" />	<span class="form-text">元</span>
								</td>
							</tr>
							<tr>
								<th>商品来源：</th>
							...
							<tr>
								<th>开始时间：</th>
								<td>
									<input name="coupon_start_time" type="text" id="coupon_start_time" class="form-int-short date" value="" />
								</td>
							</tr>
							<tr>
								<th>结束时间：</th>
								<td>
									<input name="coupon_end_time" type="text" id="coupon_end_time" class="form-int-short date" value="" />
								</td>
							</tr>
						</table>
					</div>
					<div class="bm-form" style="border:0">
						<table>
							<tr>
								<th>店铺主旺旺：</th>
								<td>
									<input name="nick" type="text" id="nick" class="form-int-short bcf" value="" readOnly="true" />
								</td>
							</tr>
							<tr>
								<th>联系人QQ：</th>
								<td>
									<input name="qq" type="text" id="qq" class="form-int-short" value="{$info.qq}" />
								</td>
							</tr>
							<tr>
								<th>联系人手机：</th>
								<td>
									<input name="telephone" type="text" id="telephone" class="form-int-short" value="{$info.mobile}" />
								</td>
							</tr>
							<tr>
								<th>联系人姓名：</th>
								<td>
									<input name="person_name" type="text" id="person_name" class="form-int-short" value="{$info.realname}" />
								</td>
							</tr>
							<tr>
								<th>推荐理由：</th>
		...
		function getTaoItem(url){
			...
			$.getJSON(FTXIAER.root + '/?m=goods&a=ajaxgetid', {url:url},function(result){
				...
				$('#inventory').val(taobaokeItem.num);
