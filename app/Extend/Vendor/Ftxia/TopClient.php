...
class TopClient
{
	...
	protected $sdkVersion = "top-sdk-php-20140401";
	...
	public function execute($request, $session = null)
	{
		...
		$this->_CachePath = $this->_CachePath . "runtime/Data/ftxia_api_cache/";
		//组装系统参数
		...
		{
			$logger = new LtLogger;
			$logger->conf["log_file"] = $this->_CachePath . "ftxia/top_biz_err_" . $this->appkey . "_" . date("Y-m-d") . ".log";
			$logger->log(array(
				date("Y-m-d H:i:s"),
				$resp
			));
