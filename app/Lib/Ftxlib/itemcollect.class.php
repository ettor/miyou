...
class itemcollect {
    ...
    public function url_parse($url) {
        ...
        $class_file = LIB_PATH . 'Ftxlib/itemcollect/'.$class.'/'.$class.'_itemcollect.class.php';
	...
	public function fetch_tb() {
        if ($this->collect_module) {
            return $this->collect_module->fetch_tb($this->url);
        } else {
            return false;
        }
    }
